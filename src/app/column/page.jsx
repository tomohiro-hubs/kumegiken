...
<section className="content-section"><div className="container column-layout">
  ...
  <div className="column-list">
    ...
    <a href={routePath("/column/nishinomiya-waterproofing-optimal-selection")} className="column-card reveal" style={{ animation: 'fadeInUp 0.35s ease forwards' }}><div className="column-card__image"><img src={assetPath("/images/optimal-selection-1.jpeg")} alt="西宮の防水工法選定ガイド" style={{ width: '100%', minHeight: '120px', objectFit: 'cover' }} /></div><div className="column-card__body"><div className="column-card__meta"><div className="column-card__date">2026.03.31</div><span className="column-card__category">防水</span></div><h3 className="column-card__title">西宮の防水工事｜雨漏りを防ぐ“最適な工法選び”と長持ちさせるポイント</h3><p className="column-card__excerpt">西宮エリアで防水工事を検討中の方へ、雨漏りを防ぐための最適な工法選びの基準や、耐用年数を長持ちさせるための施工のポイントを解説します。</p></div></a>
    )}
    {isVisible('leak-repair') && (
    <a href={routePath("/column/nishinomiya-leak-speed")} className="column-card reveal" style={{ animation: 'fadeInUp 0.35s ease forwards' }}><div className="column-card__image"><img src={assetPath("/images/leak-speed-1.jpg")} alt="雨漏り修理のスピード対応" style={{ width: '100%', minHeight: '120px', objectFit: 'cover' }} /></div><div className="column-card__body"><div className="column-card__meta"><div className="column-card__date">2026.03.31</div><span className="column-card__category">雨漏り補修</span></div><h3 className="column-card__title">西宮の雨漏り対応はスピードが命｜最短対応で被害を最小限にする方法</h3><p className="column-card__excerpt">西宮で雨漏りが発生した際になぜスピード対応が必要なのか、放置するリスク、迅速に対応できる業者の選び方を解説します。</p></div></a>
    )}
    {isVisible('waterproofing') && (
