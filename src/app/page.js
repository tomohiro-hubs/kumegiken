      ...
      <div className="service__grid">
        <a href="/service/large-scale-repair" className="service-card reveal">
          ...
          <div className="service-card__body">
            <h3 className="service-card__title">大規模修繕事業</h3>
            <p className="service-card__text">マンション・ビルの大規模修繕を、診断から施工まで一貫対応。建物の長寿命化を実現します。</p>
        ...
        <a href="/service/waterproofing" className="service-card reveal reveal--delay-1">
          ...
          <div className="service-card__body">
            <h3 className="service-card__title">防水事業</h3>
            <p className="service-card__text">ウレタン防水・シート防水・FRP防水など、建物に最適な工法をご提案。確かな技術で雨水から建物を守ります。</p>
            <span className="service-card__link">詳しく見る <i className="fas fa-arrow-right"></i></span>
          </div>
        </a>
        ...
        <a href="/service/painting" className="service-card reveal reveal--delay-2">
          ...
          <div className="service-card__body">
            ...
            <p className="service-card__text">美観と保護を両立する外壁塗装。建物の資産価値を維持しながら、美しい外観を取り戻します。</p>
            <span className="service-card__link">詳しく見る <i className="fas fa-arrow-right"></i></span>
          </div>
        </a>
        ...
        <a href="/dive-survey" className="service-card reveal">
          ...
          <div className="service-card__body">
            <h3 className="service-card__title">水中点検</h3>
            <p className="service-card__text">ダム・港湾施設・橋梁などの水中部を、専門ダイバーが安全かつ正確に点検・調査します。</p>
            <span className="service-card__link">詳しく見る <i className="fas fa-arrow-right"></i></span>
          </div>
        </a>
      </div>
