...
const workItems = [
  {
    href: "/works/nishinomiya-rooftop-waterproofing-fire-insurance-01",
    image: "/images/works-nishinomiya-rooftop-complete.jpg",
    alt: "西宮市 屋上防水工事",
    category: "防水工事",
    city: "西宮市",
    buildingType: "屋上",
    title: "西宮市 屋上防水工事（火災保険適用）",
    estimate: "工期：約2週間 / 費用目安：200〜300万円",
  },
  {
    href: "/works/osaka-rental-mansion-repair-01",
    image: "/images/works-osaka-rental-mansion-fv.jpg",
    alt: "大阪市内 賃貸マンション大規模修繕",
    category: "大規模修繕",
    city: "大阪市",
  ...
  {
    href: "/works/hyogo-rental-mansion-repair-01",
    image: "/images/works-hyogo-rental-mansion-01-fv.jpg",
    alt: "兵庫県 賃貸マンション大規模修繕",
    category: "大規模修繕",
    city: "兵庫県",
    buildingType: "賃貸マンション",
...
const columnItems = [
  {
    ...
    alt: "防水工事ガイド",
    date: "2026.03.15",
    title: "西宮市の防水工事費用相場｜工法別の目安と選び方",
    excerpt:
      "西宮市での防水工事費用の目安を解説。ウレタン防水、シート防水、FRP防水の工法別に比較します。",
  },
  {
...
const IMAGE_DIMENSIONS = {
  ...
  "/images/waterproofing-service.jpeg": { width: 1280, height: 853 },
  ...
  "/images/painting-service.jpg": { width: 4284, height: 5712 },
