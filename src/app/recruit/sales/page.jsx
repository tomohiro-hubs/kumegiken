...
export const metadata = buildMetadata({
  title: "営業職 募集要項｜西宮の防水・大規模修繕会社 久米技建",
  description: "西宮市の雨漏り補修、防水工事、大規模修繕工事を扱う久米技建の営業職募集要項。仕事内容、勤務条件、応募資格、待遇を掲載しています。",
  path: "/recruit/sales",
...
<section className="content-section"><div className="container container--narrow">
  ...
  <div style={{ textAlign: 'center', marginTop: '48px' }} className="reveal">
    <a href={routePath("/recruit/contact")} className="btn btn--primary btn--lg"><i className="fas fa-envelope"></i> 応募する / お問い合わせ</a>
  </div>
</div></section>
