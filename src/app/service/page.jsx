...
export default function Page() {
  ...
  <nav className="breadcrumb"><div className="container"><ol className="breadcrumb__list"><li><a href="/" className="breadcrumb__link">ホーム</a></li><li className="breadcrumb__separator">›</li><li>サービス一覧</li></ol></div></nav>

  <section className="content-section">
    <div className="container">
      <div className="service__grid">
        <a href="/service/large-scale-repair" className="service-card reveal">
          <div className="service-card__image"><img src="/images/large-scale-aerial.jpg" alt="大規模修繕事業" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /><span className="service-card__tag">人気No.1</span></div>
        ...
        <a href="/service/waterproofing" className="service-card reveal reveal--delay-1">
          <div className="service-card__image"><img src="/images/waterproofing-rooftop.jpg" alt="防水事業" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /><span className="service-card__tag">技術のルーツ</span></div>
        ...
        <a href="/service/painting" className="service-card reveal reveal--delay-2">
          <div className="service-card__image"><img src="/images/painting-work.jpg" alt="外壁塗装" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /></div>
        ...
        <a href="/dive-survey" className="service-card reveal">
          <div className="service-card__image"><img src="/images/dive-survey.jpg" alt="水中点検" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /><span className="service-card__tag">専門対応</span></div>
  ...
  <section className="cta-section">
    <div className="container">
      ...
      <div className="cta-section__buttons reveal">
        <a href="/contact" className="btn btn--primary btn--lg"><i className="fas fa-envelope"></i> 無料相談・お見積もり</a>
        <a href="/simulation" className="btn btn--outline btn--lg"><i className="fas fa-calculator"></i> 見積もりシミュレーション</a>
      </div>
    </div>
  </section>
