...
<section className="cta-section"><div className="container"><h2 className="cta-section__title">雨漏りでお困りですか？</h2><div className="cta-section__phone"><a href="tel:0798-27-5653" className="cta-section__phone-number" style={{ color: 'white', textDecoration: 'none' }}><i className="fas fa-phone-alt"></i> 0798-27-5653</a></div><div className="cta-section__buttons"><a href={routePath("/contact")} className="btn btn--primary btn--lg"><i className="fas fa-envelope"></i> 緊急のお問い合わせ</a></div></div></section>
