...
export default function Page() {
  ...
  <section className="content-section">
    <div className="container">
      ...
      <div className="works__grid">
        ...
        <a href={routePath("/works/nishinomiya-mansion-waterproofing-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        <a href={routePath("/works/osaka-building-large-scale-repair-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        {isVisible('painting') && (
        <a href={routePath("/works/kobe-mansion-painting-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        <a href={routePath("/works/amagasaki-shop-leak-repair-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        {isVisible('sealing') && (
        <a href={routePath("/works/nishinomiya-building-sealing-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        {isVisible('waterproofing') && (
        <a href={routePath("/works/takarazuka-mansion-waterproofing-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        {isVisible('large-scale-repair') && (
        <a href={routePath("/works/osaka-mansion-large-scale-repair-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        {isVisible('painting') && (
        <a href={routePath("/works/itami-apartment-painting-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        {isVisible('waterproofing') && (
        <a href={routePath("/works/ashiya-house-waterproofing-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
        ...
        {isVisible('waterproofing') && (
        <a href={routePath("/works/suita-factory-waterproofing-01")} className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
  ...
  <section className="cta-section"><div className="container"><h2 className="cta-section__title reveal">同じような建物でお困りですか？</h2><p className="cta-section__text reveal">まずは無料の建物診断から。お気軽にご相談ください。</p><div className="cta-section__buttons reveal"><a href={routePath("/contact")} className="btn btn--primary btn--lg"><i className="fas fa-envelope"></i> 無料相談・お見積もり</a><a href={routePath("/simulation")} className="btn btn--outline btn--lg"><i className="fas fa-calculator"></i> 見積もりシミュレーション</a></div></div></section>
