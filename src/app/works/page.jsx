    ...
    <div className="container">
      ...
      <div className="works__grid">
        ...
        <a href="/works/nishinomiya-mansion-waterproofing-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/waterproofing-rooftop.jpg" alt="屋上ウレタン防水改修工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">防水工事</span></div>
        ...
        <a href="/works/osaka-building-large-scale-repair-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/scaffold-install.jpg" alt="オフィスビル大規模修繕工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">大規模修繕</span></div>
        ...
        <a href="/works/kobe-mansion-painting-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/building-completed.jpg" alt="分譲マンション外壁塗装工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">外壁塗装</span></div>
        ...
        <a href="/works/amagasaki-shop-leak-repair-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/leak-repair.jpg" alt="店舗天井雨漏り補修工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">雨漏り補修</span></div>
        ...
        <a href="/works/nishinomiya-building-sealing-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/sealing-work.jpg" alt="商業ビル外壁シーリング工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">シーリング</span></div>
        ...
        <a href="/works/takarazuka-mansion-waterproofing-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/waterproofing-hands.jpg" alt="マンション屋上シート防水工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">防水工事</span></div>
        ...
        <a href="/works/osaka-mansion-large-scale-repair-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/large-scale-aerial.jpg" alt="分譲マンション大規模修繕工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">大規模修繕</span></div>
        ...
        <a href="/works/itami-apartment-painting-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/painting-work.jpg" alt="賃貸アパート外壁塗装工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">外壁塗装</span></div>
        ...
        <a href="/works/ashiya-house-waterproofing-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/crack-inspection.jpg" alt="戸建て住宅バルコニーFRP防水工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">防水工事</span></div>
        ...
        <a href="/works/suita-factory-waterproofing-01" className="work-card reveal" style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
          <div className="work-card__image"><img src="/images/hero-main.jpg" alt="工場屋上アスファルト防水改修工事" style={{ width: '100%', minHeight: '180px', objectFit: 'cover' }} /><span className="work-card__category">防水工事</span></div>
