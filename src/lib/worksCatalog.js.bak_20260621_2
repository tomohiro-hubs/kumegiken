...
export const WORKS_CATALOG = [
  ...
  },
  {
    ...
    buildingType: '戸建て',
    category: 'waterproofing',
    image: '/images/works-nishinomiya-veranda-waterproofing-fv.jpg',
  },
  {
  ...
  {
    slug: 'nishinomiya-rooftop-waterproofing-02',
    title: '屋上防水工事で雨漏りを根本から修繕',
    fullTitle: '西宮市 戸建住宅 屋上防水改修工事',
    location: '西宮市',
    region: 'kansai',
    buildingType: '戸建て',
    category: 'waterproofing',
